          ...
          <div className="mx-auto max-w-4xl py-32 sm:py-32 lg:py-32">
            <div className="text-center">
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6">
                <a
                  href="https://drive.google.com/file/d/1resBcNLdjTeiD9YkTY_ZjsyIpgxHrB7S/view?usp=sharing"
                  target="_blank"
                ...
                >
                  ...
                  <i
                    aria-hidden="true"
                    className="fa-solid fa-arrow-right ml-3 group-hover:translate-x-1 transition-transform"
                  ></i>
                </a>
                <a
                  href="#connect"
